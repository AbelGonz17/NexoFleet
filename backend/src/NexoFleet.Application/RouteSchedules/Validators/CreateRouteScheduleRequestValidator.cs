...
public sealed class CreateRouteScheduleRequestValidator : AbstractValidator<CreateRouteScheduleRequest>
{
    public CreateRouteScheduleRequestValidator()
    {
        RuleFor(request => request.RouteId)
            .NotEmpty().WithMessage(RouteScheduleErrors.InvalidRouteId.Description);
