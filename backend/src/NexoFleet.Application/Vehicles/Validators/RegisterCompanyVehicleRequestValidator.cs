...
public sealed class RegisterCompanyVehicleRequestValidator : AbstractValidator<RegisterCompanyVehicleRequest>
{
    public RegisterCompanyVehicleRequestValidator()
    {
